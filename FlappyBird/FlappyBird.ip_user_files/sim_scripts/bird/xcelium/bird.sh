...
#
# Script generated by Vivado on Thu Apr 11 10:47:03 -0400 2024
...
#
# Usage        : bird.sh
#                bird.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bird.sh [-reset_run]
#                bird.sh [-reset_log]
#                bird.sh [-help]
#
...
#                script (type 'bird.sh -help' for more information).
#
...
# script info
echo -e "bird.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bird.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bird xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bird -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bird_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: bird.sh [-reset_log]\n\
Usage: bird.sh [-keep_index]\n\
