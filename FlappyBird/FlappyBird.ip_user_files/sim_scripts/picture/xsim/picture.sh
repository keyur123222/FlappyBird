...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot picture xil_defaultlib.picture -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb picture.wdb xsim.dir libdpi.so)
