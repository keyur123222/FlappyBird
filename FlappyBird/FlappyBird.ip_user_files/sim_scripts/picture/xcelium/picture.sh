...
#
# Script generated by Vivado on Sun Apr 14 18:46:27 -0400 2024
...
#
# Usage        : picture.sh
#                picture.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                picture.sh [-reset_run]
#                picture.sh [-reset_log]
#                picture.sh [-help]
#
...
#                script (type 'picture.sh -help' for more information).
#
...
# script info
echo -e "picture.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./picture.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.picture xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.picture -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log picture_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: picture.sh [-step]\n\
Usage: picture.sh [-lib_map_path]\n\
Usage: picture.sh [-reset_run]\n\
Usage: picture.sh [-reset_log]\n\
Usage: picture.sh [-keep_index]\n\
