...
HD_PWD='C:/Users/keyur/Documents/Vivado/FlappyBird/FlappyBird.runs/bird_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bird.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bird.tcl
